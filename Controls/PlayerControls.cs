...
namespace The_Game.Controls
{
    public class PlayerControls
    {
        ...
        {
            if (player.State != PlayerState.Jumping) return player.Pos + 10 * player.Velocity;
        ...
        public void ProcessCollisions()
        {
            ...
            playerOffset = collisions.Where(ent => !ent.Passable).Aggregate(playerOffset, (current, solidEnt) => current + Collisions.GetCollisionOffset(player.Hitbox, solidEnt.Hitbox));
